...
const Days = () => {
  ...
  return (
    <div className="bg-slate-900 w-full min-h-[800px] flex justify-center items-center">
      
      <div className="screen bg-[url('/img/background.jpg')] border-solid border-8 relative border-black rounded-3xl w-[390px] h-[737px] overflow-y-auto text-white ">
        <main>
          <Main/>
        </main>
        <div className="p-4">
          <div className="bg-slate-800 bg-opacity-60 mt-4 p-1 rounded-xl">
            <p className="text-2xl">Dự báo 3 ngày</p>
            <hr />
            {data.map((d,index) => {
              return (
                <div key={index} className="bg-slate-900 bg-opacity-60 px-8 py-2 mt-2 text-sm flex items-center justify-between text-sm rounded-xl text-center">
